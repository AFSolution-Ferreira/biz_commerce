...
return [
    ...
    */
    ...
    'attributes'           => [
        ...
        'phone' => 'telefone',
        'phone_type' => 'tipo',
        'phone_operator' => 'operadora',
        'phone_type2' => 'tipo',
        'phone_operator2' => 'operadora',
        'email' => 'e-mail',
        'formation' => 'grau de formação',
        'graduation' => 'curso de formação',
        'computer_competences' => 'nível de informática',
        'company' => 'empresa',
        'date_in' => 'data de entrada',
        'date_out' => 'data de saída',
        'occupation' => 'função exercida',
        'occupation_abstract' => 'resumo da função',
        'date_in2' => 'data de entrada',
        'date_out2' => 'data de saída',
        'occupation2' => 'função exercida',
        'occupation_abstract2' => 'resumo da função',
        'intended_position' => 'cargo pretendido',
        'objective' => 'objetivo do currículo',
        'salary' => 'pretenção salarial',
    ],
